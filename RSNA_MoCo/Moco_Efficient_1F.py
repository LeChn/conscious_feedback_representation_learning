...
import socket
from sklearn.metrics.ranking import roc_auc_score
from dataset_new import RSNA_Data_finetune
...
def parse_option():
    ...
    parser.add_argument('--model_path', type=str,
                        default="/home/charlietran/rsnaproject/MIRL-master/modelpath/ckpt_epoch_110.pth",
    ...
    parser.add_argument('--train_txt', type=str,
                        default="/home/charlietran/rsnaproject/MIRL-master/experiments_configure/RSNAFTR_1F.txt")
    parser.add_argument('--val_txt', type=str,
                        default="/home/charlietran/rsnaproject/MIRL-master/experiments_configure/RSNAFVAL_ALL.txt")
