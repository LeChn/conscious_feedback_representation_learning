...
from multilabel_eval_MoCo import train
from torchvision import transforms, datasets
from util import adjust_learning_rate, AverageMeter
from MoCo_factory import train_supervised, validate_multilabel, val_loader, train_loader_supervised
...
def parse_option():
    ...
    parser.add_argument('--data_folder', type=str, default="/media/ubuntu/data/RSNATR")
    ...
    parser.add_argument('--model_path', type=str, default='/home/ubuntu/wbm/MICCAI 2020/RSNAMODELS')
    parser.add_argument('--tb_path', type=str, default='/home/ubuntu/wbm/MICCAI 2020/RSNATB')
    # loss function
...
def main():
    ...
    train_txt = "/media/ubuntu/data/train.txt"
    ...
    for epoch in range(args.start_epoch, args.epochs + 1):
        ...
        if args.moco:
            ...
            mean_auc_train = train_supervised(epoch, train_loader_supervised, model, classifier, criterion_supervised, optimizer_supervised, args)
            auc_test, mean_auc_test, test_loss = validate_multilabel(val_loader, model, classifier, criterion_supervised, args)
